...
const UI = {
  ja: {
    ...
    searchButton:'検索', recommended:'おすすめ', searchResults:q=>`「${q}」の検索結果`, resultCount:c=>`${c}件`,
  ...
  en: {
    ...
    searchButton:'Search', recommended:'Recommended', searchResults:q=>`Search results for “${q}”`, resultCount:c=>`${c} results`,
